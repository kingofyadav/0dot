...
| Marketing footer | `src/components/marketing/MarketingFooter.tsx` | **Redesign Phase 3.** `"/"` footer — brand mark + three link groups, real routes only (`/about`, `/help`, pricing are still Future per ROADMAP.md). |
