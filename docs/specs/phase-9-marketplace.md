...
Status: Built — shipped at `/m`, not the roadmap's `/store` name. This spec describes target state and is not edited to match the implementation — see `../ROADMAP.md`'s build-status table and `../../README.md`.
Owner: TBD
