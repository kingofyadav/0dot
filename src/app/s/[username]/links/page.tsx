    ...
    <div className="settingsSection">
      ...
      {links.map((link, index) => {
        ...
        return (
          <div
            key={link.id}
            className={`settingsGroup${link.isFeatured ? " featuredLink" : ""}`}
            style={{ opacity: isScheduledHidden ? 0.5 : 1, marginBottom: "var(--space-3)" }}
          >
            <SettingsRow
              icon={Link2}
              label={
      ...
      <div className="settingsGroup" style={{ marginTop: "var(--space-3)" }}>
        <div className="settingsAddPanelBody">
          <AddLinkForm />
        </div>
      </div>
