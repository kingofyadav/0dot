...
INSERT INTO "new_Post" ("authorId", "body", "createdAt", "deletedAt", "id", "likeCount", "replyCount", "replyToId", "repostCount", "repostOfId", "trendingScore") SELECT "authorId", "body", "createdAt", "deletedAt", "id", "likeCount", "replyCount", "replyToId", "repostCount", "repostOfId", "trendingScore" FROM "Post";
DROP TABLE "Post";
