...
INSERT INTO "new_Post" ("acceptedAnswerId", "authorId", "body", "communityId", "createdAt", "deletedAt", "flairId", "id", "likeCount", "pinnedAt", "postType", "replyCount", "replyToId", "repostCount", "repostOfId", "trendingScore") SELECT "acceptedAnswerId", "authorId", "body", "communityId", "createdAt", "deletedAt", "flairId", "id", "likeCount", "pinnedAt", "postType", "replyCount", "replyToId", "repostCount", "repostOfId", "trendingScore" FROM "Post";
DROP TABLE "Post";
